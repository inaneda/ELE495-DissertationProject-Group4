...
def validate_required_gcodes() -> None:
    required = [
        ...
        "BLOCK_1_PICK", "BLOCK_1_TEST", # direnc
        "BLOCK_2_PICK", "BLOCK_2_TEST", # direnc
        "BLOCK_3_PICK", "BLOCK_3_TEST", "BLOCK_3_PLACE", # diyot test sonrasi direkt pcb'ye
        "BLOCK_4_PICK", "BLOCK_4_TEST", "BLOCK_4_PLACE", # diyot
        "BLOCK_5_PICK", "BLOCK_5_TEST", "BLOCK_5_RETURN", # direnc
        "BLOCK_6_PICK", "BLOCK_6_TEST", "BLOCK_6_RETURN", # direnc
        "BLOCK_7_PICK", "BLOCK_7_TEST", "BLOCK_7_RETURN", # direnc
        "BLOCK_8_PICK", "BLOCK_8_TEST", "BLOCK_8_RETURN", # direnc
# ***
        "BLOCK_1_RETURN", "BLOCK_2_RETURN", # test sonrasi R1 ve R2 donsün diye
# *** ^
        # en son secilen deger PCB'ye yerlestirilecek
        # burada secilen degerdeki birakilmali
        # "PLACE_SELECTED_R1", "PLACE_SELECTED_R2",
        # "BLOCK_1_PLACE", "BLOCK_2_PLACE", 
    ]
...
# direncleri test et ve yerlerine koy, diyotlari test et ve pcb'deki yerlerine koy
        # Step (id, label, gcode, vacuum_expected)
...
# ***
        ...
        Step("BLOCK_1_RETURN", "1. BLOK RETURN", GCODE["BLOCK_1_RETURN"], vacuum_expected=False),
# *** ^
...
# ***
        ...
        Step("BLOCK_2_RETURN", "2. BLOK RETURN", GCODE["BLOCK_2_RETURN"], vacuum_expected=False),
# *** ^
...
# ***    
        # bunlar gercek gcode degil gcode_runner bunlari gorunce ozel fonksiyon cagriyor 
        Step("PLACE_SELECTED_R1", "PLACE SELECTED R1", [], vacuum_expected=False, marks_done_component="R1"),
        Step("PLACE_SELECTED_R2", "PLACE SELECTED R2", [], vacuum_expected=False, marks_done_component="R2"),
# *** ^
    ]
